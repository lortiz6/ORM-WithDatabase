...
import type { ApolloQueryResult, DefaultContext, InternalRefetchQueriesInclude, InternalRefetchQueriesMap, InternalRefetchQueriesOptions, MutationUpdaterFunction, OnQueryUpdated, OperationVariables } from "@apollo/client/core/types.js";
import type { ErrorPolicy, MutationFetchPolicy, MutationOptions, QueryOptions, SubscriptionOptions, WatchQueryOptions } from "@apollo/client/core/watchQueryOptions.js";
import type { ApolloLink, FetchResult } from "@apollo/client/link/core";
import { DocumentTransform, Observable } from "@apollo/client/utilities";
